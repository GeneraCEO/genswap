...
const TV_PERP_MAP: Record<string, string> = {
  ...
  // Memecoins
  kPEPE: 'BINANCE:PEPEUSDT', WIF: 'BINANCE:WIFUSDT', kBONK: 'BINANCE:BONKUSDT',
  kFLOKI: 'BINANCE:FLOKIUSDT', POPCAT: 'BYBIT:POPCATUSDT', BOME: 'BINANCE:BOMEUSDT',
  NOT: 'BINANCE:NOTUSDT', TURBO: 'BINANCE:TURBOUSDT', BRETT: 'BYBIT:BRETTUSDT',
  kSHIB: 'BINANCE:SHIBUSDT', MEME: 'BINANCE:MEMEUSDT',
  // DeFi & Altcoins
  AAVE: 'BINANCE:AAVEUSDT', UNI: 'BINANCE:UNIUSDT', MKR: 'BINANCE:MKRUSDT',
  CRV: 'BINANCE:CRVUSDT', LDO: 'BINANCE:LDOUSDT', SNX: 'BINANCE:SNXUSDT',
  COMP: 'BINANCE:COMPUSDT', SUSHI: 'BINANCE:SUSHIUSDT', GMX: 'BINANCE:GMXUSDT',
  PENDLE: 'BINANCE:PENDLEUSDT', JUP: 'BINANCE:JUPUSDT', EIGEN: 'BINANCE:EIGENUSDT',
  FET: 'BINANCE:FETUSDT', TAO: 'BINANCE:TAOUSDT', AR: 'BINANCE:ARUSDT',
  FIL: 'BINANCE:FILUSDT', HBAR: 'BINANCE:HBARUSDT', RUNE: 'BINANCE:RUNEUSDT',
  STX: 'BINANCE:STXUSDT', IMX: 'BINANCE:IMXUSDT', PYTH: 'BINANCE:PYTHUSDT',
  TRX: 'BINANCE:TRXUSDT', BCH: 'BINANCE:BCHUSDT', LTC: 'BINANCE:LTCUSDT',
  ETC: 'BINANCE:ETCUSDT', APT: 'BINANCE:APTUSDT', SEI: 'BINANCE:SEIUSDT',
  WLD: 'BINANCE:WLDUSDT', STRK: 'BINANCE:STRKUSDT', ETHFI: 'BINANCE:ETHFIUSDT',
  JTO: 'BINANCE:JTOUSDT', W: 'BINANCE:WUSDT', ZETA: 'BINANCE:ZETAUSDT',
  ZRO: 'BINANCE:ZROUSDT', BLAST: 'BYBIT:BLASTUSDT', ZK: 'BINANCE:ZKUSDT',
  IO: 'BYBIT:IOUSDT', GALA: 'BINANCE:GALAUSDT', ENS: 'BINANCE:ENSUSDT',
  ORDI: 'BINANCE:ORDIUSDT', NEO: 'BINANCE:NEOUSDT', CAKE: 'BINANCE:CAKEUSDT',
  KAS: 'BINANCE:KASUSDT', BLUR: 'BINANCE:BLURUSDT',
};
